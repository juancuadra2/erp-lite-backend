...
class UpdatePaymentMethodRequestDtoTest {
    ...
    void shouldTestEqualsAndHashCode() {
        // Given
        UpdatePaymentMethodRequestDto dto1 = UpdatePaymentMethodRequestDto.builder()
                .code("CASH")
                .name("Efectivo")
                .enabled(true)
                .build();

        UpdatePaymentMethodRequestDto dto2 = UpdatePaymentMethodRequestDto.builder()
                .code("CASH")
                .name("Efectivo")
                .enabled(true)
                .build();

        UpdatePaymentMethodRequestDto dto3 = UpdatePaymentMethodRequestDto.builder()
                .code("CARD")
                .name("Tarjeta")
                .enabled(false)
                .build();
