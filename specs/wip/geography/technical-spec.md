...
public interface CreateDepartmentUseCase {
    DepartmentResponseDto execute(CreateDepartmentRequestDto request);
}

public interface GetDepartmentUseCase {
    DepartmentResponseDto execute(UUID uuid);
}

public interface UpdateDepartmentUseCase {
    DepartmentResponseDto execute(UUID uuid, UpdateDepartmentRequestDto request);
}

public interface ListDepartmentsUseCase {
    PagedResponseDto<DepartmentResponseDto> execute(
...
public interface SearchDepartmentsUseCase {
    List<DepartmentResponseDto> execute(String name);
}

// Municipality Use Cases
public interface CreateMunicipalityUseCase {
    MunicipalityResponseDto execute(CreateMunicipalityRequestDto request);
}

public interface GetMunicipalityUseCase {
    MunicipalityResponseDto execute(UUID uuid);
}

public interface UpdateMunicipalityUseCase {
    MunicipalityResponseDto execute(UUID uuid, UpdateMunicipalityRequestDto request);
}

public interface ListMunicipalitiesUseCase {
    PagedResponseDto<MunicipalityResponseDto> execute(
        UUID departmentId, Boolean enabled, String name, Pageable pageable);
}

public interface SearchMunicipalitiesUseCase {
    List<MunicipalityResponseDto> execute(String name);
}

public interface AutocompleteMunicipalitiesUseCase {
    List<MunicipalityAutocompleteDto> execute(
        String query, UUID departmentId, Integer limit);
}
```
...
public interface DepartmentPort {
    ...
    List<Department> findByEnabled(Boolean enabled, Pageable pageable);
...
public interface MunicipalityPort {
    ...
    Optional<Municipality> findByCodeAndDepartment(String code, UUID departmentId);
    List<Municipality> findByDepartment(UUID departmentId, Pageable pageable);
    List<Municipality> findByNameContaining(String name, Integer limit);
    void deleteByUuid(UUID uuid);
...
public class MunicipalityEntity {
    ...
    // Audit fields (same as Department)
}
```
...
public interface DepartmentJpaRepository 
    ...
    List<DepartmentEntity> findByEnabled(Boolean enabled, Pageable pageable);
...
public interface MunicipalityJpaRepository 
    ...
    Optional<MunicipalityEntity> findByCodeAndDepartmentId(
        String code, Long departmentId);
    List<MunicipalityEntity> findByDepartmentId(
        Long departmentId, Pageable pageable);
    List<MunicipalityEntity> findByNameContainingIgnoreCase(
...
public class DepartmentController {
    ...
    public DepartmentResponseDto getByUuid(@PathVariable UUID uuid) {
        return getUseCase.execute(uuid);
    }
    
    @GetMapping
    public PagedResponseDto<DepartmentResponseDto> list(
        @RequestParam(required = false) Boolean enabled,
        @RequestParam(required = false) String name,
        Pageable pageable) {
        return listUseCase.execute(enabled, name, pageable);
    }
...
public class MunicipalityController {
    ...
    public List<MunicipalityAutocompleteDto> autocomplete(
        @RequestParam String query,
        @RequestParam(required = false) UUID departmentId,
        @RequestParam(defaultValue = "10") Integer limit) {
        return autocompleteUseCase.execute(query, departmentId, limit);
    }
}
```
